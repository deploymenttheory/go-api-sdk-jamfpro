...
func main() {
	...
	// Call the GetComputerHistoryByComputerNameAndDataSubset function
	computerHistory, err := client.GetComputerHistoryByComputerNameAndDataSubset(computerName, DataSubset)
	if err != nil {
		log.Fatalf("Error fetching computer inventory by name: %v", err)
	}
