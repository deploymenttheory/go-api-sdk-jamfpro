...
func main() {
	...
	// Call the GetComputerHistoryByComputerUDIDAndDataSubset function
	computerHistory, err := client.GetComputerHistoryByComputerUDIDAndDataSubset(computerUDID, DataSubset)
	if err != nil {
