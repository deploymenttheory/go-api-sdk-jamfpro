...
func main() {
	...
	err = client.CreateFileAttachment(
		"ebooks", // resource type / computers / mobiledevices / enrollment profiles / printers / peripherals / policies /  ebooks / mobiledeviceapplicationsicon / mobiledeviceapplicationsipa / diskencryptionconfigurations
