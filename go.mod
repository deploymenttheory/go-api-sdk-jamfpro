...
require (
	...
	github.com/deploymenttheory/go-api-http-client v0.2.7-0.20240709151232-a91aad71be93
	github.com/deploymenttheory/go-api-http-client-integrations v0.0.8-0.20240709151431-dcf2d5f12c21
