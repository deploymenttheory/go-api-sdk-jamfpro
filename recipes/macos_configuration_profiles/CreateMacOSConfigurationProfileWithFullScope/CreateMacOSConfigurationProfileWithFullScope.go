...
func main() {
	...
	profile := jamfpro.ResourceMacOSConfigurationProfile{
		General: jamfpro.MacOSConfigurationProfileSubsetGeneral{
			Name:               "jamfprosdk-test-profile-with-full-scope",
			Description:        "",
		...
		Scope: jamfpro.MacOSConfigurationProfileSubsetScope{
			...
			Computers: []jamfpro.MacOSConfigurationProfileSubsetComputer{
				{MacOSConfigurationProfileSubsetScopeEntity: jamfpro.MacOSConfigurationProfileSubsetScopeEntity{ID: 16}},
				{MacOSConfigurationProfileSubsetScopeEntity: jamfpro.MacOSConfigurationProfileSubsetScopeEntity{ID: 20}},
				{MacOSConfigurationProfileSubsetScopeEntity: jamfpro.MacOSConfigurationProfileSubsetScopeEntity{ID: 21}},
			},
			ComputerGroups: []jamfpro.MacOSConfigurationProfileSubsetScopeEntity{
				{ID: 1},
				{ID: 78},
			},
			Buildings: []jamfpro.MacOSConfigurationProfileSubsetScopeEntity{
				{ID: 1348},
				{ID: 1349},
			},
			Departments: []jamfpro.MacOSConfigurationProfileSubsetScopeEntity{
				{ID: 37287},
				{ID: 37288},
			},
			JSSUsers: []jamfpro.MacOSConfigurationProfileSubsetScopeEntity{
				{ID: 1},
				{ID: 2},
			},
			JSSUserGroups: []jamfpro.MacOSConfigurationProfileSubsetScopeEntity{
				{ID: 4},
				{ID: 505},
			},
			Limitations: jamfpro.MacOSConfigurationProfileSubsetLimitations{
				NetworkSegments: []jamfpro.MacOSConfigurationProfileSubsetNetworkSegment{
					{MacOSConfigurationProfileSubsetScopeEntity: jamfpro.MacOSConfigurationProfileSubsetScopeEntity{ID: 4}},
					{MacOSConfigurationProfileSubsetScopeEntity: jamfpro.MacOSConfigurationProfileSubsetScopeEntity{ID: 5}},
				},
				IBeacons: []jamfpro.MacOSConfigurationProfileSubsetScopeEntity{
					{ID: 3},
					{ID: 4},
				},
				Users: []jamfpro.MacOSConfigurationProfileSubsetScopeEntity{
					{Name: "Jane Smith"},
					{Name: "John Doe"},
				},
			},
