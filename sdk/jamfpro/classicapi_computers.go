...
type ResponseComputer struct {
	General struct {
		...
		} `xml:"remote_management" json:"remote_management"`
		...
		} `xml:"mdm_capable_users" json:"mdm_capable_users"`
		...
		} `xml:"management_status" json:"management_status"`
	...
	} `xml:"purchasing" json:"purchasing"`
	Peripherals struct {
		...
		Peripherals []struct {
			...
			} `xml:"attachments>attachment" json:"attachments"`
		} `xml:"peripheral" json:"peripherals"`
	} `xml:"peripherals" json:"peripherals"`
	Hardware struct {
		...
		} `xml:"filevault2_users>user" json:"filevault_2_users"`
		Storage []struct {
			...
			} `xml:"partition" json:"partitions"`
		} `xml:"storage>device" json:"storage"`
		MappedPrinters []struct {
			Name     string `xml:"name" json:"name"`
			URI      string `xml:"uri" json:"uri"`
			Type     string `xml:"type" json:"type"`
			Location string `xml:"location" json:"location"`
		} `xml:"mapped_printers>printer" json:"mapped_printers"`
	} `xml:"hardware" json:"hardware"`
	Certificates []struct {
		...
		Name         string `xml:"name" json:"name"`
	} `xml:"certificates>certificate" json:"certificates"`
	Security struct {
	...
	Software struct {
		...
		} `xml:"available_updates>update" json:"available_updates"`
		RunningServices []string `xml:"running_services>name" json:"running_services"`
		Applications    []struct {
			Name    string `xml:"name" json:"name"`
			Path    string `xml:"path" json:"path"`
			Version string `xml:"version" json:"version"`
		} `xml:"applications>application" json:"applications"`
		Fonts []struct {
			Name    string `xml:"name" json:"name"`
			Path    string `xml:"path" json:"path"`
			Version string `xml:"version" json:"version"`
		} `xml:"fonts>font" json:"fonts"`
		Plugins []struct {
			Name    string `xml:"name" json:"name"`
			Path    string `xml:"path" json:"path"`
			Version string `xml:"version" json:"version"`
		} `xml:"plugins>plugin" json:"plugins"`
	} `xml:"software" json:"software"`
	ExtensionAttributes []struct {
		ID    int    `xml:"id" json:"id"`
		Name  string `xml:"name" json:"name"`
		Type  string `xml:"type" json:"type"`
		Value string `xml:"value" json:"value"`
	} `xml:"extension_attributes>extension_attribute" json:"extension_attributes"`
	GroupsAccounts struct {
		ComputerGroupMemberships []struct {
			Group string `xml:"group" json:"group"`
		} `xml:"computer_group_memberships>group" json:"computer_group_memberships"`
		...
		} `xml:"local_accounts>user" json:"local_accounts"`
	} `xml:"groups_accounts" json:"groups_accounts"`
	ConfigurationProfiles []struct {
		ID          int    `xml:"id" json:"id"`
		Name        string `xml:"name" json:"name"`
		UUID        string `xml:"uuid" json:"uuid"`
		IsRemovable bool   `xml:"is_removable" json:"is_removable"`
	} `xml:"configuration_profiles>configuration_profile" json:"configuration_profiles"`
}
