...
type PolicySubsetGeneral struct {
	...
	DateTimeLimitations        PolicySubsetDateTimeLimitations `xml:"date_time_limitations,omitempty"`
	NetworkLimitations         PolicySubsetNetworkLimitations  `xml:"network_limitations,omitempty"`
	OverrideDefaultSettings    PolicySubsetOverrideSettings    `xml:"override_default_settings,omitempty"`
	NetworkRequirements        string                          `xml:"network_requirements,omitempty"`
	Site                       PolicySubsetSite                `xml:"site"`
}
...
type PolicySubsetDateTimeLimitations struct {
...
type PolicySubsetNetworkLimitations struct {
...
type PolicySubsetOverrideSettings struct {
	TargetDrive       string `xml:"target_drive,omitempty"`
